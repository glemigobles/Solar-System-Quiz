...
public class Main extends AppCompatActivity {
    ...
    public static Answer_OneCorrect currentAnswerOne;
    public static Answer_WriteDown currentAnswerWriteDown;
    public static Answer_ThreeCorrect currentAnswerThreeCorrect;
